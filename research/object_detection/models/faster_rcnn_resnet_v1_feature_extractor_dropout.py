    ...
    with tf.variable_scope(self._architecture, reuse=self._reuse_weights):
      with slim.arg_scope(
        ...
        with slim.arg_scope([slim.batch_norm],
          ...
          # Force dropout, apply it both at test and training time
          proposal_classifier_features = tf.layers.dropout(resnet_utils.stack_blocks_dense(
              proposal_feature_maps, blocks),rate = 0.5,training=True)
