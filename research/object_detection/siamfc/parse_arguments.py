...
def parse_arguments(in_hp={}, in_evaluation={}, in_run={}):
    ...
    with open('siamfc/parameters/hyperparams.json') as json_file:
        hp = json.load(json_file)
    with open('siamfc/parameters/evaluation.json') as json_file:
        evaluation = json.load(json_file)
    with open('siamfc/parameters/run.json') as json_file:
        run = json.load(json_file)
    with open('siamfc/parameters/environment.json') as json_file:
        env = json.load(json_file)
    with open('siamfc/parameters/design.json') as json_file:
