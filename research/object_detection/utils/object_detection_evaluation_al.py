...
class DetectionEvaluator(object):
  ...
  @abstractmethod
  def add_single_detected_image_info(self, image_id, detections_dict, prediction_dict):
...
class ObjectDetectionEvaluatorAL(DetectionEvaluator):
  ...
  def __init__(self,
    ...
    """
    super(ObjectDetectionEvaluatorAL, self).__init__(categories)
    ...
    self._evaluation = ObjectDetectionEvaluationAL(
  ...
  def add_single_detected_image_info(self, image_id, detections_dict, prediction_dict):
    ...
    self._evaluation.add_single_detected_image_info(
        ...
        detected_scores_with_background=prediction_dict['class_predictions_with_background'])
  ...
  def get_detections(self):
      return self._evaluation.get_detections()

  def get_groundtruths(self):
      return self._evaluation.get_groundtruths()

class PascalDetectionEvaluator(ObjectDetectionEvaluatorAL):
...
class WeightedPascalDetectionEvaluator(ObjectDetectionEvaluatorAL):
...
class PascalInstanceSegmentationEvaluator(ObjectDetectionEvaluatorAL):
...
class WeightedPascalInstanceSegmentationEvaluator(ObjectDetectionEvaluatorAL):
...
class ObjectDetectionEvaluationAL(object):
  ...
  def _initialize_detections(self):
    ...
    # New fields to keep boxes
    self.detected_boxes = {}
    self.detected_scores = {}
    self.detected_class_labels = {}
    self.detected_scores_with_background = {}
  ...
  def add_single_detected_image_info(self, image_key, detected_boxes,
                                     ...
                                     detected_masks=None,detected_scores_with_background=None):
    """Adds detections for a single image to be used for evaluation.
    ...
    # Store more information about detections for active learning 
    self.detected_boxes[image_key] = detected_boxes
    self.detected_scores[image_key] = detected_scores
    self.detected_class_labels[image_key] = detected_class_labels
    self.detected_scores_with_background[image_key] = detected_scores_with_background
  ...
  def get_groundtruths(self):
      return {'boxes': self.groundtruth_boxes, 'labels':self.groundtruth_class_labels}
